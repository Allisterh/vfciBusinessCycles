...
data <- get_var_data(end_date = as.Date("2022-07-01"), vfci = "vfci_fgr1consumption")
x <- data
x[, t := .I - lags]

mv_list <- list(
  max_share_vfci_2017_pcecc96 =
    get_var_data(end_date = as.Date("2017-01-01"), vfci = "vfci_fgr1pcecc96") |>
    fit_var(lags) |>
    id_fevdfd("vfci", bc_freqs),
  max_share_vfci_2022_pcecc96 =
    get_var_data(end_date = as.Date("2022-01-01"), vfci = "vfci_fgr1pcecc96") |>
    fit_var(lags) |>
    id_fevdfd("vfci", bc_freqs),
  max_share_vfci_2017 =
    get_var_data(end_date = as.Date("2017-01-01"), vfci = "vfci_fgr1consumption") |>
    fit_var(lags) |>
    id_fevdfd("vfci", bc_freqs),
  max_share_vfci_2022 =
    get_var_data(end_date = as.Date("2022-07-01"), vfci = "vfci_fgr1consumption") |>
    fit_var(lags) |>
    id_fevdfd("vfci", bc_freqs)
)

colors <- c(
  max_share_vfci_2017_pcecc96 = "steelblue",
  max_share_vfci_2022_pcecc96 = "lightblue",
  max_share_vfci_2017 = "firebrick",
  max_share_vfci_2022 = "lightpink"
)
```
