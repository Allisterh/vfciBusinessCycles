...
mv_list <- list(
  ...
  max_share_u_vfcigdpc1 =
    get_var_data(end_date = end_date, vfci = "vfci_fgr1gdpc1") |>
    fit_var(lags) |>
    id_fevdfd("unemployment", bc_freqs),
  max_share_u_vfcioutput =
    get_var_data(end_date = end_date, vfci = "vfci_fgr1output") |>
    fit_var(lags) |>
    id_fevdfd("unemployment", bc_freqs),
  max_share_u_vfcipcecc96 =
    get_var_data(end_date = end_date, vfci = "vfci_fgr1pcecc96") |>
    fit_var(lags) |>
    id_fevdfd("unemployment", bc_freqs),
  max_share_u_vfciconsumption =
    get_var_data(end_date = end_date, vfci = "vfci_fgr1consumption") |>
    fit_var(lags) |>
    id_fevdfd("unemployment", bc_freqs)
)
...
colors <- c(
  max_share_u = "black",
  max_share_u_vfcigdpc1 = "steelblue",
  max_share_u_vfcioutput = "goldenrod",
  max_share_u_vfcipcecc96 = "forestgreen",
  max_share_u_vfciconsumption = "firebrick"
)
```
