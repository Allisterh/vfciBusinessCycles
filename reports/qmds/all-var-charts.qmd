...
```{r plot_fevdfd_bc, echo = F, warning = F, fig.height = 5, out.width = "100%", fig.cap = "FEVDFD - Zoomed to BC Freqs"}
fevdfd_df |>
...
```{r plot_fevfd_bc, echo = F, warning = F, fig.height = 5, out.width = "100%", fig.cap = "FEV FD - Zoomed to BC Freqs"}
fevfd_df[f <= pi] |>
  _[f %between% (bc_freqs + c(-0.1, 0.1))] |>
  _[impulse == "Main" | impulse == "Chol_1"] |>
  ggplot(aes(
...
summary_table |>
  ...
  fmt_percent(columns = c("avg_fevdfd", "wavg_fevdfd", "total_ratio"), decimals = 1) |>
