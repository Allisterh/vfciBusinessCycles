...
mv_list <- list(
  ...
  het_reg_u = id_linear_het_reg(v, "unemployment", hetreg_method = "twostep"),
  het_reg_u_lags = id_linear_het_reg(v, "unemployment", het_reg_lags = 0:2, hetreg_method = "twostep")
)
