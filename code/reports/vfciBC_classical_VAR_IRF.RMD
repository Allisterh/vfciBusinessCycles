...
df |>
    dplyr::filter((target == "vfci" & sign == "neg" & period_l == 60 & period_h == 98) | (target == "unemployment" & sign == "pos" & period_l == 6 & period_h == 32)) |>
    ggplot(aes(
        x = h,
        y = irf,
        color = label
...
df |>
    dplyr::filter((target == "vfci" & sign == "neg" & period_l == 32 & period_h == 40) | (target == "unemployment" & sign == "pos" & period_l == 22 & period_h == 32)) |>
    ggplot(aes(
        x = h,
        y = irf,
        color = label
...
df |>
    dplyr::filter((target == "vfci" & sign == "neg" & period_l == 24 & period_h == 30) | (target == "unemployment" & sign == "pos" & period_l == 24 & period_h == 30)) |>
    ggplot(aes(
        x = h,
        y = irf,
        color = label
...
df |>
    dplyr::filter((target == "vfci" & sign == "neg" & period_l == 6 & period_h == 24) | (target == "unemployment" & sign == "pos" & period_l == 6 & period_h == 24)) |>
    ggplot(aes(
        x = h,
        y = irf,
        color = label
...
Picking the VFCI Iteration that most closely matches the Main Business Cycle shock for just the unemployment impulse responses (target: unemployment, 6 - 32 q).  Prefers an even longer period shock.
...
df |>
    dplyr::filter((target == "vfci" & sign == "neg" & period_l == 170 & period_h == 200) | (target == "unemployment" & sign == "pos" & period_l == 6 & period_h == 32)) |>
    ggplot(aes(
        x = h,
        y = irf,
        color = label
...
Picking the two iterations of VFCI and Unemployment that are most closely similar for the unemployment irf.  Similar frequency as before.
...
```{r, echo = F, warning = F, fig.height = 3, out.width = "100%"}
df |>
    dplyr::filter((target == "vfci" & sign == "neg" & period_l == 28 & period_h == 34) | (target == "unemployment" & sign == "pos" & period_l == 24 & period_h == 30)) |>
    ggplot(aes(
        x = h,
        y = irf,
        color = label
