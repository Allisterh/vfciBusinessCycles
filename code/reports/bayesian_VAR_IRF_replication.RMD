...
```{r plotRepBayFDsmall, echo = F, warning = F, fig.cap = "Replication of Bayesian VAR targetting Frequency Domain, 1000 burnin (small)", fig.height = 2.5, out.width = "100%"}
df[(model == "bayesian_fd" & version == "original") | model == "bayesian_fd_small"] |>
    ggplot(aes(
        x = h,
        color = version,
        fill = version
...
```{r plotRepBayFDexact, echo = F, warning = F, fig.cap = "Replication of Bayesian VAR targetting Frequency Domain, exact priors", fig.height = 2.5, out.width = "100%"}
df[(model == "bayesian_fd" & version == "original") | model == "bayesian_fd_exact"] |>
    ggplot(aes(
        x = h,
        color = version,
        fill = version
...
```{r plotRepBayTD4small, echo = F, warning = F, fig.cap = "Replication of Bayesian VAR targetting Time Domain: 4, 1000 burnin (small)", fig.height = 2.5, out.width = "100%"}
df[(model == "bayesian_td4" & version == "original") | model == "bayesian_td4_small"] |>
    ggplot(aes(
        x = h,
        color = version,
        fill = version
...
```{r plotRepBayTD4exact, echo = F, warning = F, fig.cap = "Replication of Bayesian VAR targetting Time Domain: 4, exact priors", fig.height = 2.5, out.width = "100%"}
df[(model == "bayesian_td4" & version == "original") | model == "bayesian_td4_exact"] |>
    ggplot(aes(
        x = h,
        color = version,
        fill = version
...
For the next three plots, the replication only targets a time horizon of 32, instead of the full range of 6:32, as the original BCA code does not correctly target the full range.
...
```{r plotRepBayTD632small, echo = F, warning = F, fig.cap = "Replication of Bayesian VAR targetting Time Domain: 6:32, 1000 burnin (small)", fig.height = 2.5, out.width = "100%"}
df[(model == "bayesian_td632" & version == "original") | model == "bayesian_td32_small"] |>
    ggplot(aes(
        x = h,
        color = version,
        fill = version
...
```{r plotRepBayTD632exact, echo = F, warning = F, fig.cap = "Replication of Bayesian VAR targetting Time Domain: 6:32, exact priors", fig.height = 2.5, out.width = "100%"}
df[(model == "bayesian_td632" & version == "original") | model == "bayesian_td32_exact"] |>
    ggplot(aes(
        x = h,
        color = version,
        fill = version
