...
data <-
  list(
    fread("./data/paper-figures/charts/q-fevdfd.csv"),
    fread("./data/paper-figures/charts/q-chol.csv"),
    fread("./data/paper-figures/charts/q-hetreg.csv")
  ) |>
  purrr::list_rbind() |>
  copy()
...
t |>
  writeLines("./paper-figures/tables/q.tex")
